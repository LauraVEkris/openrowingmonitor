...
test('Test behaviour for three perfect identical strokes, including settingling behaviour of metrics', () => {
  ...
  testCycleLinearVelocity(rower, 4.602786705707755)
  testCyclePower(rower, 273.0364203476704)
  testDriveDuration(rower, 0.25056694500000004)
  testDriveLinearDistance(rower, 0.5023136271345706)
  testDriveLength(rower, 0.3371976114853044)
  testDriveAverageHandleForce(rower, 237.22583895515524)
  testDrivePeakHandleForce(rower, 396.7733761769528)
  testRecoveryDuration(rower, 0.10957031000000017)
  testRecoveryDragFactor(rower, 309.02744980039836)
  ...
  testCycleLinearDistance(rower, 1.2557840678364274)
  testCycleLinearVelocity(rower, 4.600477371517923)
  testCyclePower(rower, 272.62565872880714)
  testDriveDuration(rower, 0.2616664540000002)
  testDriveLinearDistance(rower, 1.20555270512297)
  testDriveLength(rower, 0.3518583772020566)
  testDriveAverageHandleForce(rower, 281.10680300217416)
  ...
  testTotalNumberOfStrokes(rower, 3)
  testTotalLinearDistanceSinceStart(rower, 4.705600971166435)
  testCycleDuration(rower, 0.42544705400000016)
  testCycleLinearDistance(rower, 1.90879178311137)
  testCycleLinearVelocity(rower, 4.486555413100521)
  testCyclePower(rower, 252.86990157529135)
  testDriveDuration(rower, 0.2616664540000002)
  testDriveLinearDistance(rower, 1.20555270512297)
  testDriveLength(rower, 0.3518583772020566)
  testDriveAverageHandleForce(rower, 281.10680300217416)
...
test('sample data for NordicTrack RX800 should produce plausible results', async () => {
  ...
  testTotalLinearDistanceSinceStart(rower, 79.07423613076111)
  testTotalNumberOfStrokes(rower, 10)
...
test('A full session for a Concept2 RowErg should produce plausible results', async () => {
  ...
  testTotalLinearDistanceSinceStart(rower, 2028.9360483913765)
