...
test('Test behaviour for three perfect identical strokes, including settingling behaviour of metrics', () => {
  ...
  testCycleLinearDistance(rower, 0.2491943602992768)
  ...
  testCycleLinearVelocity(rower, 3.225335147958214)
  testCyclePower(rower, 93.94692707812303)
  ...
  testTotalLinearDistanceSinceStart(rower, 1.5782562351248521)
  testTotalNumberOfStrokes(rower, 2)
  testCycleDuration(rower, 0.34889498300000005)
  testCycleLinearDistance(rower, 1.1154667088547667)
  ...
  testTotalLinearDistanceSinceStart(rower, 2.3100595961479735)
  testTotalNumberOfStrokes(rower, 2)
  ...
  testTotalLinearDistanceSinceStart(rower, 3.2370105201105934)
  testTotalNumberOfStrokes(rower, 3)
  testCycleDuration(rower, 0.3601372550000002)
  testCycleLinearDistance(rower, 1.0245247054323694)
  testCycleLinearVelocity(rower, 4.470427238223009)
  testCyclePower(rower, 250.15265872931366)
  testDriveDuration(rower, 0.23985939100000003)
  testDriveLinearDistance(rower, 0.4878689073487469)
  testDriveLength(rower, 0.322536845768552)
  testDriveAverageHandleForce(rower, 220.88036022749515)
  testDrivePeakHandleForce(rower, 380.1396336085015)
  testRecoveryDuration(rower, 0.12027786400000018)
  testRecoveryDragFactor(rower, 283.12720365097886)
  ...
  testTotalLinearDistanceSinceStart(rower, 3.968813881133715)
  testTotalNumberOfStrokes(rower, 3)
  testCycleDuration(rower, 0.3712367640000004)
  testCycleLinearDistance(rower, 1.2196722683718684)
  testCycleLinearVelocity(rower, 4.46818431211662)
  testCyclePower(rower, 249.77632391313173)
  testDriveDuration(rower, 0.2509589000000002)
  testDriveLinearDistance(rower, 1.1220984869021189)
  testDriveLength(rower, 0.33719761148530436)
  testDriveAverageHandleForce(rower, 273.1514952195131)
  ...
  testTotalNumberOfStrokes(rower, 3)
  testTotalLinearDistanceSinceStart(rower, 4.603043460687086)
  testCycleDuration(rower, 0.42544705400000016)
  testCycleLinearDistance(rower, 1.8539018479252403)
  testCycleLinearVelocity(rower, 4.357538336427733)
  testCyclePower(rower, 231.67633867720645)
  testDriveDuration(rower, 0.2509589000000002)
  testDriveLinearDistance(rower, 1.1220984869021189)
  testDriveLength(rower, 0.33719761148530436)
  testDriveAverageHandleForce(rower, 273.1514952195131)
...
test('sample data for NordicTrack RX800 should produce plausible results', async () => {
  ...
  testTotalLinearDistanceSinceStart(rower, 79.0605678779862)
  testTotalNumberOfStrokes(rower, 10)
  // As dragFactor is dynamic, it should have changed
  testRecoveryDragFactor(rower, 493.1279600644757)
})
...
test('A full session for SportsTech WRX700 should produce plausible results', async () => {
  ...
  testTotalLinearDistanceSinceStart(rower, 8408.91479919923)
...
test('A full session for a Concept2 RowErg should produce plausible results', async () => {
  ...
  testTotalLinearDistanceSinceStart(rower, 2028.941557924713)
  testTotalNumberOfStrokes(rower, 206)
  // As dragFactor isn't static, it should have changed
  testRecoveryDragFactor(rower, 80.79182853890549)
})
