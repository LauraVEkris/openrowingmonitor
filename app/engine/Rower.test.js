...
test('Test behaviour for three perfect identical strokes, including settingling behaviour of metrics', () => {
  ...
  testCycleLinearVelocity(rower, 3.444581676393284)
  testCyclePower(rower, 114.43727094360004)
  testDriveDuration(rower, 0.19636192600000005)
  testDriveLinearDistance(rower, 0.6763846922408941)
  testDriveLength(rower, 0.27855454861829493)
  ...
  testTotalLinearDistanceSinceStart(rower, 2.380326117962418)
  testTotalNumberOfStrokes(rower, 2)
  ...
  testTotalLinearDistanceSinceStart(rower, 3.3347220095181034)
  testTotalNumberOfStrokes(rower, 3)
  testCycleDuration(rower, 0.3490464680000002)
  testCycleLinearDistance(rower, 1.0046272542691423)
  testCycleLinearVelocity(rower, 4.605127838825823)
  testCyclePower(rower, 273.4532589902021)
  testDriveDuration(rower, 0.25056694500000004)
  ...
  testTotalLinearDistanceSinceStart(rower, 4.08819245021996)
  testTotalNumberOfStrokes(rower, 3)
  testCycleDuration(rower, 0.3712367640000004)
  testCycleLinearDistance(rower, 1.3060154305498848)
  testCycleLinearVelocity(rower, 4.600477371517924)
  testCyclePower(rower, 272.62565872880725)
  ...
  testTotalNumberOfStrokes(rower, 3)
  testTotalLinearDistanceSinceStart(rower, 4.741200165494902)
  testCycleDuration(rower, 0.43653784100000015)
  testCycleLinearDistance(rower, 1.9590231458248268)
  testCycleLinearVelocity(rower, 4.487636492949133)
  testCyclePower(rower, 253.05274012748467)
  testDriveDuration(rower, 0.2727572410000002)
  testDriveLinearDistance(rower, 1.2557840678364274)
  testDriveLength(rower, 0.36651914291880905)
  testDriveAverageHandleForce(rower, 272.78784054454604)
  testDrivePeakHandleForce(rower, 456.96817421200865)
  testRecoveryDuration(rower, 0.16378059999999994)
  testRecoveryDragFactor(rower, 309.02744980039836)
  testInstantHandlePower(rower, 0)
})
...
test('sample data for NordicTrack RX800 should produce plausible results', async () => {
  ...
  testTotalLinearDistanceSinceStart(rower, 80.09099811113543)
  testTotalNumberOfStrokes(rower, 10)
  // As dragFactor is dynamic, it should have changed
  testRecoveryDragFactor(rower, 493.1279600644751)
})
...
test('A full session for SportsTech WRX700 should produce plausible results', async () => {
  ...
  testTotalLinearDistanceSinceStart(rower, 8408.914799199278)
...
test('A full session for a Concept2 RowErg should produce plausible results', async () => {
  ...
  testTotalLinearDistanceSinceStart(rower, 2029.7644289621187)
  testTotalNumberOfStrokes(rower, 206)
  // As dragFactor isn't static, it should have changed
  testRecoveryDragFactor(rower, 80.7904433692073)
})
